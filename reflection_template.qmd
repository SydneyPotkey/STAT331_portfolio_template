...
ca_childcare <- anti_join(childcare_costs, 
                           california_counties, 
                           by = "county_fips_code")
...
-   Example of **dplyr** pipeline Lab 4 Question 6
...
-   Example of function formatting Lab 7 Question Question 4
...
rescale_01 <- function(vec){
  ...
  scaled_vec <- (vec - min(vec, na.rm = TRUE)) / (max(vec, na.rm = TRUE) - min(vec, na.rm = TRUE))
